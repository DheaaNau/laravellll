  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
         <div class= container>
          <a class="nav-link active" aria-current="page" a href="<?php echo e(url('table')); ?>">Back</a>
        </li>
      </ul>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\belajar-laravel-dhea\resources\views/isi_laporan.blade.php ENDPATH**/ ?>